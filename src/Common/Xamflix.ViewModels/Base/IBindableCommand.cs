...
{
    /// <summary>
    ///     <see cref="IBindableCommand" /> is extension to <see cref="ICommand" /> to allow binding support, which is, of
    ///     course done through
    ///     <see cref="INotifyPropertyChanged" /> interface. Any command, that will require state binding should implement this
    ///     interface.
    /// </summary>
