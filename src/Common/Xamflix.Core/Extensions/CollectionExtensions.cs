...
namespace Xamflix.Core.Extensions
{
    public static class CollectionExtensions
    {
        ...
        /// <summary>
        ///     Inserts the range of items specified by <paramref name="toInsert" /> into the <paramref name="items" /> list at
        ...
        /// <summary>
        ///     Compares to <see cref="IEnumerable" /> collections bit by bit for equality using
        ///     <see cref="ObjectExtensions.ObjectsEqual" /> extension method.
        ///     Collections are considered equal if they are both <code>null</code>, or they have same length and are equal bit by
        ///     bit.
        /// </summary>
        ...
        /// <summary>
        ///     Gets the sub list inside <paramref name="collection" /> starting at index <paramref name="startIndex" /> with
        ///     length <paramref name="count" /> or until
